...
from svea_core.data import TrajDataHandler
from svea_core.controllers import pure_pursuit
...
class SVEAPurePursuit(SVEAManager):
    ...
    def __init__(self, Node=Node, localizer=None, controller=None, traj_x=[], traj_y=[],
                 data_handler=TrajDataHandler, vehicle_name=''):
        

        SVEAManager.__init__(self, Node=Node, localizer=localizer, controller=controller,
...
class SVEAPlatoonMember(SVEAPurePursuit):
    ...
    def __init__(self, Node, localizer, traj_x, traj_y, data_handler=TrajDataHandler,
                 vehicle_name=''):

        SVEAPurePursuit.__init__(self, Node, localizer,
