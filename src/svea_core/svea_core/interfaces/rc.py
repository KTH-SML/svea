...
class RCInterface(object):
    ...
    def __init__(self, Node=Node, vehicle_name='', log_length=100):
        self.node = Node
    ...
    def _init_and_spin_ros(self):
        self.node.get_logger().info("Starting RC Interface Node for "
                      + self.vehicle_name)
    ...
    def _start_listen(self):
        ...
        self.node.create_subscription(self, lli_ctrl, 
                                 self._rc_topic,
                                 self._read_rc,
                                 qos_profile)
        # rclpy.Subscriber(self._rc_topic,
        #                  lli_ctrl,
        #                  self._read_rc,
        #                  tcp_nodelay=True)
