...
if __name__ == '__main__':
    try:
        yaml_file_path = '/svea_ws/src/svea_navigation/scripts/util/simulated_trajectories/two_ped_faraway.yaml'   # sidewalk_DKv_30_east_to_west_multiple_pedestrians_rand, sidewalk_DKv_30_east_to_west_one_pedestrian
