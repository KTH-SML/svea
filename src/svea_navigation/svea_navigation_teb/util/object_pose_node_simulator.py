...
if __name__ == '__main__':
    try:
        yaml_file_path = '/svea_ws/src/svea_navigation/maps/simulated_trajectories/sidewalk_DKv_30_east_to_west_multiple_pedestrians_rand.yaml'   #two_ped_faraway, sidewalk_DKv_30_east_to_west_multiple_pedestrians_rand, sidewalk_DKv_30_east_to_west_one_pedestrian
