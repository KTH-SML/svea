...
class KeyTeleop():
    ...
    def __init__(self, interface):
        ...
        self._num_steps = rospy.get_param('~turbo/steps', 9)

        forward_min = rospy.get_param('~turbo/linear_forward_min', 0.1)
        forward_max = rospy.get_param('~turbo/linear_forward_max', 1)
        self._forward = Velocity(forward_min, forward_max, self._num_steps)

        backward_min = rospy.get_param('~turbo/linear_backward_min', 0.1)
        backward_max = rospy.get_param('~turbo/linear_backward_max', 1)
        self._backward = Velocity(backward_min, backward_max, self._num_steps)

        angular_min = rospy.get_param('~turbo/angular_min', 4)
        angular_max = rospy.get_param('~turbo/angular_max', 40)
